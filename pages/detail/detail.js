...
Page({
  ...
  onShow:function(){
    if(app.user_login==''){
      this.setData({
        loveimage:'cloud://test-env-8ger46eu356799f7.7465-test-env-8ger46eu356799f7-1304156061/程序配置图片/love.png'
      })
    }else if(app.user_login.love.indexOf(this.data.idsave)<0) {
      this.setData({
        loveimage:'cloud://test-env-8ger46eu356799f7.7465-test-env-8ger46eu356799f7-1304156061/程序配置图片/取消赞.png'
      })
    }else{
      this.setData({
        loveimage:'cloud://test-env-8ger46eu356799f7.7465-test-env-8ger46eu356799f7-1304156061/程序配置图片/love.png'
    ...
    if(this.data.names==undefined){
      ...
      .then(res=>{
        ...
        if(User.data[0].love.indexOf(that.data.idsave)>=0) {
          ...
          .update({
            data:{
              love:db.command.pull(that.data.idsave)
            },
            success:function(){
              db.collection('user')
              .where({
